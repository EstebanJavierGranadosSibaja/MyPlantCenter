...
from models.plant_detection_model import PlantDetectionModel
from models.plant_tag_model import PlantTagModel
from models.friend_request_model import FriendRequestModel
...
def main() -> int:
    service_account_path = Path("secrets/service-account.json").resolve()
