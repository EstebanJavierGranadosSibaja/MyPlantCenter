 ...
 * Input: data/seed/db.normalized.seed.json
...
const serviceAccountPath = path.join(root, "secrets", "service-account.json");
const seedPath = path.join(root, "data", "seed", "db.normalized.seed.json");
