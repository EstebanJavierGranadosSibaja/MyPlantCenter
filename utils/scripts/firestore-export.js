 ...
 * Input: Firestore project configured by utils/secrets/service-account.json
 * Output: utils/data/backup.json
 */
...
const outputPath = path.join(utilitiesRoot, "data", "backup.json");
